      ...
      {/* Location Selection Card */}
        <div className="space-y-4 p-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-end">
            <Dialog>
              <DialogTrigger className="flex items-center py-1.5 px-4 rounded-md shadow-lg text-white gap-x-1 bg-teal-500 hover:bg-teal-600">
                Add to reports <PlusCircle className="h-4 w-4" />
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Select a collection</DialogTitle>
                  <DialogDescription>
                    Select a collection where your report is or want to create
                    new one
                  </DialogDescription>
                </DialogHeader>
              </DialogContent>
